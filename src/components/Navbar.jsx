    ...
    return (
        ...
        <nav class="navbar navbar-expand-lg bg-dark fixed-top p-3">
            <div class="container-fluid">
                <div className="logo d-flex gap-3 ms-5 ">                   
                    ...
                    <button type="button" class="btn btn-dark  p-1 ps-3 pe-3 btn-outline-danger text-light"><b>DELIVERY</b></button>
                    <button type="button" class="btn btn-dark btn-lg "><b>PICKUP</b></button>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="d-flex" role="search">
                        ...
                        <button class="btn btn-outline-danger me-3 text-light" type="submit"><b>LOGIN</b></button>
                    </form>
                </div>
            </div>
        </nav>
